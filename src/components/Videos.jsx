...
function Videos() {
    ...
    return (
        <Stack direction={['coloum', 'row']} h={"100vh"}>
            <VStack w={'full'}>
                <video
                    src={videoSrc}
                    controls
                ...
                <VStack alignItems={'flex-start'} p={'8'} w={'full'} overflowY={'auto'}>
                    ...
                    <Text> Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                        Inventore assumenda repudiandae repellat quas fugiat itaque
      ...
      >
                ...
                {/* {
                    videosArr.map((item,index) => (
                        <Button variant={'ghost'} colorScheme={'purple'} onClick={() => setVideoSrc(item)} >Lecture{index + 1}     
